...
|22	|void set(int year, int month, int date, int hour, int minute, int second)  <br>设置为字段的年，月，日，小时，分钟和秒的值.|
|23	|void setGregorianChange(Date date) <br>设置GregorianCalendar更改日期.|
